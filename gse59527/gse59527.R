...
####################################################################################
####################################################################################
#PLATFORM:  [MoGene-2_0-st] Affymetrix Mouse Gene 2.0 ST Array
#3 types of factors: WT and Gdap1-null reprogramemd fibroblasts on 4 day
####################################################################################
####################################################################################
current_gse = "gse59527"
...
#STEP 2: subset data
current_gse_phenoData = current_gse_phenoData[1:6,]
current_gse_assayData = current_gse_assayData[,1:6]
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density before WT", current_gse, sep = " "))
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density after filtering by treshold WT", current_gse, sep = " "))
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density after scaling WT", current_gse, sep = " "))
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density after quantile normalization WT", current_gse, sep = " "))
colnames(current_gse_assayData) = rownames(current_gse_phenoData)
rownames(current_gse_assayData) = current_gse_featureData$ID

#STEP 6: add entrez ids
#add entrez ids
entrez_vec = mogene2entrez_mm(current_gse_featureData$ID)
...
cluster_plot = ggplot(cluster_values, aes(cluster_values[,1], cluster_values[,2])) +
  ...
  labs(colour = "days", title = paste("PCA plot","WT", current_gse, sep = " "))
cluster_plot
...
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("final density WT", current_gse, sep = " "))


#STEP 9: limma
days_vec = as.numeric(c(rep(0,3), rep(1,3)))
...
ggplot(first_entity_df, aes(day, first_entity_df, color = day))  + geom_point() +
  labs(colour = "days", x = "age", y = "expression", title = paste("entrez ID WT", first_entity, current_gse, sep = " ")) +
  scale_x_continuous(labels = as.character(days_vec), breaks = days_vec)

save(top_genes_limma,file="gse59527/top_genes_WT.Rda")
...
#STEP 2: subset data
current_gse_phenoData = current_gse_phenoData[7:12,]
current_gse_assayData = current_gse_assayData[,7:12]
current_gse_featureData = current_gse_featureData
rownames(current_gse_assayData) = current_gse_featureData$ID
#STEP 3: remove outliers
#current_gse_assayData = current_gse_assayData[,c(1:2, 4:10)]
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density before Gdap1-null", current_gse, sep = " "))
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density after filtering by treshold Gdap1-null", current_gse, sep = " "))
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density after scaling Gdap1-null", current_gse, sep = " "))
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density after quantile normalization Gdap1-null", current_gse, sep = " "))
colnames(current_gse_assayData) = rownames(current_gse_phenoData)
rownames(current_gse_assayData) = current_gse_featureData$ID
...
cluster_plot = ggplot(cluster_values, aes(cluster_values[,1], cluster_values[,2])) +
  geom_point(aes(color = current_gse_phenoData$title)) + 
  labs(colour = "days", title = paste("PCA plot","Gdap1-null", current_gse, sep = " "))
cluster_plot
...
current_gse_assayData_fd = current_gse_assayData
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("final density Gdap1-null", current_gse, sep = " "))
...
first_entity_df$day = days_vec
ggplot(first_entity_df, aes(day, first_entity_df, color = day))  + geom_point() +
  labs(colour = "days", x = "age", y = "expression", title = paste("entrez ID Gdap1-null", first_entity, current_gse, sep = " ")) +
  scale_x_continuous(labels = as.character(days_vec), breaks = days_vec)

save(top_genes_limma,file="gse59527/top_genes_Gdap1-null.Rda")
