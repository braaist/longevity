...
####################################################################################
####################################################################################
#PLATFORM:  Affymetrix Mouse Genome 430A 2.0 Array
#2 Tissue types: MEF and hepatocytes
####################################################################################
####################################################################################
current_gse = "gse114581"
...
#STEP 2: subset data
#MEF's
current_gse_phenoData = current_gse_phenoData[c(1, 11:19),]
current_gse_assayData = current_gse_assayData[,c(1, 11:19)]
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density before MEF", current_gse, sep = " "))
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density after filtering by treshold MEF", current_gse, sep = " "))
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density after scaling MEF", current_gse, sep = " "))
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density after quantile normalization MEF", current_gse, sep = " "))
...
cluster_plot = ggplot(cluster_values, aes(cluster_values[,1], cluster_values[,2])) +
  ...
  labs(colour = "days", title = paste("PCA plot","MEF", current_gse, sep = " "))
cluster_plot
...
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("final density MEF", current_gse, sep = " "))


#STEP 9: limma
scps = strsplit(as.character(current_gse_phenoData$title), ' ')
days_vec = c()
for (i in scps){
  days_vec = c(days_vec, i[2])
}
...
save(top_genes_limma,file="gse114581//top_genes_MEF.Rda")
...
#STEP 2: subset data
#hepatocytes
current_gse_phenoData = current_gse_phenoData[c(22, 25:26),]
current_gse_assayData = current_gse_assayData[,c(22, 25:26)]
rownames(current_gse_assayData) = current_gse_featureData$ID
#STEP 3: remove outliers
##no
#and check density again
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density before HEP", current_gse, sep = " "))
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density after filtering by treshold HEP", current_gse, sep = " "))
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density after scaling HEP", current_gse, sep = " "))
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density after quantile normalization HEP", current_gse, sep = " "))
colnames(current_gse_assayData) = rownames(current_gse_phenoData)
rownames(current_gse_assayData) = current_gse_featureData$ID
...
cluster_plot = ggplot(cluster_values, aes(cluster_values[,1], cluster_values[,2])) +
  geom_point(aes(color = current_gse_phenoData$title)) + 
  labs(colour = "days", title = paste("PCA plot","HEP", current_gse, sep = " "))
cluster_plot
...
current_gse_assayData_fd = current_gse_assayData
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("final density HEP", current_gse, sep = " "))
...
first_entity_df$day = days_vec
ggplot(first_entity_df, aes(day, first_entity_df, color = day))  + geom_point() +
  labs(colour = "days", x = "age", y = "expression", title = paste("entrez ID HEP", first_entity, current_gse, sep = " ")) +
  scale_x_continuous(labels = as.character(days_vec), breaks = days_vec)

save(top_genes_limma,file="gse114581//top_genes_HEP.Rda")
