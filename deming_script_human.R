...
#load .Rds objects
logFCmatrixregr = readRDS("logFCmatrixregr_human.Rds")
cortestsign500 = readRDS("cortestsign500_human.Rds")
totalrownamematrix = readRDS("totalrownamematrix_human.Rds")
...
saveRDS(kres, file = "deming_result_human.Rds")