...
#load .Rds objects
logFCmatrixregr = readRDS("logFCmatrixregr_all.Rds")
cortestsign500 = readRDS("cortestsign500_all.Rds")
totalrownamematrix = readRDS("totalrownamematrix_all.Rds")
...
saveRDS(kres, file = "deming_result_all.Rds")