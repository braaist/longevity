...
#load .Rds objects
logFCmatrixregr = readRDS("logFCmatrixregr_full.Rds")
cortestsign500 = readRDS("cortestsign500_full.Rds")
totalrownamematrix = readRDS("totalrownamematrix_full.Rds")
...
saveRDS(kres, file = "deming_result_full.Rds")