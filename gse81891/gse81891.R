...
#2 types of factors: OSKM and OSvKM
####################################################################################
####################################################################################
current_gse = "gse81891"
...
#and check density
current_gse_assayData_fd = data.frame(pops)
...
#STEP 2: subset data
current_gse_phenoData = current_gse_phenoData[7:11,]
current_gse_assayData = current_gse_assayData[,7:11]
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density before OS(v)KM", current_gse, sep = " "))
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density after filtering by treshold OS(v)KM", current_gse, sep = " "))
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density after scaling OS(v)KM", current_gse, sep = " "))
...
visualstack = stack(current_gse_assayData_fd)
ggplot(visualstack, aes=(x=values)) + geom_density(aes(x=values, group=ind, color=ind)) + 
  labs(colour = "days", title = paste("density after quantile normalization OS(v)KM", current_gse, sep = " "))
colnames(current_gse_assayData) = rownames(current_gse_phenoData)
rownames(current_gse_assayData) = current_gse_featureData$ID

#STEP 6: add entrez ids
#add entrez ids
entrez_vec = ilmna2entrez_hs(current_gse_featureData$ID)
...
#STEP 2: subset data
#OSKM
current_gse_phenoData = current_gse_phenoData[c(4:6, 10:11),]
current_gse_assayData = current_gse_assayData[,c(4:6, 10:11)]
current_gse_featureData = current_gse_featureData
rownames(current_gse_assayData) = current_gse_featureData$ID
#STEP 3: remove outliers
#current_gse_assayData = current_gse_assayData[,c(1:2, 4:10)]
...
save(top_genes_limma,file="gse81891/top_genes_OSKM.Rda")
